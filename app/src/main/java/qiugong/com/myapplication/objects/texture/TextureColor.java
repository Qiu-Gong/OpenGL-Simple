 ...
 */
public class TextureColor extends Objects<TextureColorShaderProgram> {
    ...
    public void bindData(TextureColorShaderProgram program, float[] color) {
        this.bindData(program);
        GLES20.glUniform3fv(program.getFilterUniformLocation(), 1, color, 0);
    }

    @Override
    public void bindData(TextureColorShaderProgram program) {
